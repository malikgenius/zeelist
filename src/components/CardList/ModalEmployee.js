  ...
  render() {
    ...
    return (
      <div>
        ...
        >
          <ModalHeader toggle={this.props.isClose}>
            ...
            {this.props.employee.jd || this.props.employee.dob ? (
              ...
              >
                ...
                Joined: {moment.unix(this.props.employee.jd).fromNow()} in{" "}
                {moment.unix(this.props.employee.jd).format("YYYY")}{" "}
            ...
            <Media>
              <Media left href="#">
                {this.props.employee.imageURL ? (
                  <Media
                    object
                    style={{ maxWidth: "100px", marginRight: 5 }}
              ...
              <Media body>
                <Media heading>{this.props.employee.position}</Media>
                <CardText>
          ...
          <ModalFooter>
            ...
            >
              ...
              <ModalBody>
                Do you really want to Delete {this.props.employee.name}
              </ModalBody>
              <ModalFooter>
                <Link
                  to={{
                    pathname: "./deleteemployee",
            ...
            <Button outline color="secondary" onClick={this.props.isClose}>
              Cancel
            </Button>
          </ModalFooter>
        </Modal>

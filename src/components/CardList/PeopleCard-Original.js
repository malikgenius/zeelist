    ...
    <div>
      <Card>
        ...
        <CardBody>
          ...
          <CardText><CardImg style={{width: 15, marginRight: 10}}width="10%" src="/assets/cellphone.svg" />
            <a style={{textDecoration: 'none', color: '#117a8b'}}href={`tel:${this.props.employee.phone}`}>{this.props.employee.phone}</a>
            {/* {`${props.employee.phone}`}  */}
            <CardImg style={{width: 20, marginRight: 10, marginLeft: 10,}}width="10%" src="/assets/phone-icon.svg" />{`${this.props.employee.extension}`}
          </CardText>

...
export default (employees, filters) => {
  return employees.filter((employee) => {
   const textMatch = employee.name.toLowerCase().includes(filters.text.toLowerCase()) ||
                    ...
                    employee.extension.toLowerCase().includes(filters.text.toLowerCase()) ||
                    employee.gender.toLowerCase().includes(filters.text.toLowerCase()) ||
                    employee.hod.toLowerCase().includes(filters.text.toLowerCase()) ||
                    employee.department.toLowerCase().includes(filters.text.toLowerCase()) ||
                    employee.position.toLowerCase().includes(filters.text.toLowerCase()) ||
                    ...
                    moment.unix(employee.dob).format("DD/MMMM", "DD/MM").toLowerCase().includes(filters.text.toLowerCase());
